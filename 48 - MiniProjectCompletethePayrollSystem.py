...
class Programmer:
    ...
    def __init__(self, name, age, address, phone, programming_languages):
        ...
        print("Monthly bonus and salary of {} are {} and {} respectively".format(self.name, Programmer.monthlyBonus, Programmer.salary))


class Assistant:
    # Add the class attributes
    salary = 2500
    monthlyBonus = int(1.5 % salary)
    ...
    def __init__(self, name, age, address, phone, bilingual):
        ...
        print("Monthly bonus and salary of {} are {} and {} respectively".format(self.name, Assistant.monthlyBonus, Assistant.salary))
